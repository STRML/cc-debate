...
def pick(registry, seats, deepest, installed, min_effort, private=False):
...
def main():
    ...
    assignment, err, nlabs = pick(reg, seats, deepest, installed, a.min_effort, private=a.private_repo)
